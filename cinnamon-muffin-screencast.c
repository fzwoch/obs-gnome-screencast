/*
 * obs-cinnamon-muffin-screencast. OBS Studio source plugin.
 * Copyright (C) 2019-2020 Florian Zwoch <fzwoch@gmail.com>
 *
 * This file is part of obs-cinnamon-muffin-screencast.
 *
 * obs-cinnamon-muffin-screencast is free software: you can redistribute it and/or modify
 * it under the terms of the GNU General Public License as published by
 * the Free Software Foundation, either version 2 of the License, or
 * (at your option) any later version.
 *
 * obs-cinnamon-muffin-screencast is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
 * GNU General Public License for more details.
 *
 * You should have received a copy of the GNU General Public License
 * along with obs-cinnamon-muffin-screencast. If not, see <http://www.gnu.org/licenses/>.
 */
...
static void update_plug_names(data_t *data)
{
	...
	display_config = g_dbus_connection_call_sync(
		dbus, "org.cinnamon.muffin.DisplayConfig",
...
static void update_windows(data_t *data)
{
	...
	// FIXME: How do we call the cinnamon equivalent of a 'Shell'?
	eval_res = g_dbus_connection_call_sync(
		dbus, "org.cinnamon.Shell", "/org/cinnamon/Shell", "org.cinnamon.Shell",
...
{
	return "Cinnamon Muffin Screen Cast";
}
...
static void *_start(void *p)
{
	...
	// TODO: check for any ScreenCast schemas that may be needed for muffin
	session_res = g_dbus_connection_call_sync(
		dbus, "org.cinnamon.muffin.ScreenCast",
		"/org/cinnamon/muffin/ScreenCast", "org.cinnamon.muffin.ScreenCast",
	...
	if (window_id == 0) {
		stream_res = g_dbus_connection_call_sync(
			// FIXME: check schemas
			dbus, "org.cinnamon.muffin.ScreenCast", session_path,
			"org.cinnamon.muffin.ScreenCast.Session", "RecordMonitor",
		...
		stream_res = g_dbus_connection_call_sync(
			// FIX ME: check schemas
			dbus, "org.cinnamon.muffin.ScreenCast", session_path,
			"org.cinnamon.muffin.ScreenCast.Session", "RecordWindow",
	...
	// FIXME: check schemas
	g_dbus_connection_call_sync(dbus, "org.cinnamon.muffin.ScreenCast",
				    session_path,
...
static void start(data_t *data)
{
	...
	data->thread = g_thread_new("OBS Cinnamon screen cast", _start, data);
...
bool obs_module_load(void)
{
	struct obs_source_info info = {
		.id = "cinnamon-muffin-screencast-source",
